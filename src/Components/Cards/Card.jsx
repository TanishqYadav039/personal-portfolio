        ...
        <>
            <div className={className}>
                <div className='w-[98%] h-1/2 border-2 rounded-lg flex items-center justify-center'>
                    <img src={projectimg ? projectimg : "https://img.freepik.com/free-vector/realistic-weather-widget_1284-4092.jpg?ga=GA1.1.506606616.1746703658&semt=ais_hybrid&w=740"} alt="project-1" className='w-full h-full object-cover 2xl:text-2xl rounded-lg' />
                </div>
